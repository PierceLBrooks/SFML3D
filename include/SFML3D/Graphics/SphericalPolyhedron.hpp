...
#ifndef SFML3D_SPHERICALPOLYHEDRON_HPP
#define SFML3D_SPHERICALPOLYHEDRON_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API SphericalPolyhedron : public Polyhedron
{
public :
...
#endif // SFML3D_SPHERICALPOLYHEDRON_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::SphericalPolyhedron
/// \ingroup graphics
///
...
/// Usage example:
/// \code
/// sf3d::SphericalPolyhedron sphere;
/// sphere.setRadius(150);
/// sphere.setColor(sf3d::Color::Red);
...
/// "subdivisions" property of sf3d::SphericalPolyhedron defines how many
/// subdivisions to perform on the faces of the base primitive,
/// and therefore defines the quality of the sphere.
///
/// \see sf3d::Polyhedron, sf3d::Cuboid, sf3d::ConvexPolyhedron
///
////////////////////////////////////////////////////////////
