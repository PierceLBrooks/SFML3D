...
#ifndef SFML3D_TRANSFORM_HPP
#define SFML3D_TRANSFORM_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API Transform
{
public :
    ...
    ///
    /// Since SFML3D doesn't provide support for oriented rectangles,
    ...
    ///
    /// Since SFML3D doesn't provide support for oriented boxes,
    /// the result of this function is always an axis-aligned
    ...
    /// \code
    /// sf3d::Transform transform;
    /// transform.translate(sf3d::Vector3f(100, 200, 300)).rotate(45);
    /// \endcode
    ///
    ...
    /// \code
    /// sf3d::Transform transform;
    /// transform.rotate(90, sf3d::Vector2f(8, 3)).translate(sf3d::Vector2f(50, 20));
    /// \endcode
    ///
    /// \param angle Rotation angle, in degrees
    ...
    /// \code
    /// sf3d::Transform transform;
    /// transform.rotate(90, sf3d::Vector3f(8, 3, 5)).translate(sf3d::Vector2f(50, 20));
    /// \endcode
    ///
    /// \param angle Rotation angle, in degrees
    ...
    /// \code
    /// sf3d::Transform transform;
    /// transform.scale(sf3d::Vector3f(2, 1, 3)).rotate(45);
    /// \endcode
    ///
    ...
    /// \code
    /// sf3d::Transform transform;
    /// transform.scale(sf3d::Vector2f(2, 1), sf3d::Vector2f(8, 3)).rotate(45);
    /// \endcode
    ///
    /// \param factors Scaling factors
...
///
////////////////////////////////////////////////////////////
SFML3D_GRAPHICS_API Transform operator *(const Transform& left, const Transform& right);
...
///
////////////////////////////////////////////////////////////
SFML3D_GRAPHICS_API Transform& operator *=(Transform& left, const Transform& right);
...
///
////////////////////////////////////////////////////////////
SFML3D_GRAPHICS_API Vector3f operator *(const Transform& left, const Vector3f& right);

} // namespace sf3d


#endif // SFML3D_TRANSFORM_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::Transform
/// \ingroup graphics
///
/// A sf3d::Transform specifies how to translate, rotate, scale,
...
/// sf3d::Transform translation;
/// translation.translate(20, 50);
///
/// // define a rotation transform
/// sf3d::Transform rotation;
/// rotation.rotate(45);
///
/// // combine them
/// sf3d::Transform transform = translation * rotation;
///
/// // use the result to transform stuff...
/// sf3d::Vector2f point = transform.transformPoint(10, 20);
/// sf3d::FloatRect rect = transform.transformRect(sf3d::FloatRect(0, 0, 10, 100));
/// \endcode
///
/// \see sf3d::Transformable, sf3d::RenderStates
///
////////////////////////////////////////////////////////////
