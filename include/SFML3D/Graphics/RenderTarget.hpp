...
#ifndef SFML3D_RENDERTARGET_HPP
#define SFML3D_RENDERTARGET_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API RenderTarget : NonCopyable
{
public :
    ...
    ///
    /// This function can be used when you mix SFML3D drawing
    /// and direct OpenGL rendering. Combined with PopGLStates,
    /// it ensures that:
    /// \li SFML3D's internal states are not messed up by your OpenGL code
    /// \li your OpenGL states are not modified by a call to a SFML3D function
    ///
    ...
    /// states needed by SFML3D are set, so that subsequent draw()
...
#include <SFML3D/Graphics/RenderTarget.inl>

} // namespace sf3d


#endif // SFML3D_RENDERTARGET_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::RenderTarget
/// \ingroup graphics
///
/// sf3d::RenderTarget defines the common behaviour of all the
/// 2D render targets usable in the graphics module. It makes
/// it possible to draw 2D entities like sprites, shapes, text
/// without using any OpenGL command directly.
///
/// A sf3d::RenderTarget is also able to use views (sf3d::View),
/// which are a kind of 2D cameras. With views you can globally
/// scroll, rotate or zoom everything that is drawn,
/// without having to transform every single entity. See the
/// documentation of sf3d::View for more details and sample pieces of
/// code about this class.
///
/// On top of that, render targets are still able to render direct
/// OpenGL stuff. It is even possible to mix together OpenGL calls
/// and regular SFML3D drawing commands. When doing so, make sure that
/// OpenGL states are not messed up by calling the
/// pushGLStates/popGLStates functions.
///
/// \see sf3d::RenderWindow, sf3d::RenderTexture, sf3d::View
///
////////////////////////////////////////////////////////////
