...
#ifndef SFML3D_RECT_HPP
#define SFML3D_RECT_HPP
...
#include <SFML3D/Graphics/Rect.inl>
...
/// (Vector2 and Vector3).
///
/// To keep things simple, sf3d::Rect doesn't define
/// functions to emulate the properties that are not directly
/// members (such as right, bottom, center, etc.), it rather
/// only provides intersection functions.
///
/// sf3d::Rect uses the usual rules for its boundaries:
/// \li The left and top edges are included in the rectangle's area
/// \li The right (left + width) and bottom (top + height) edges are excluded from the rectangle's area
///
/// This means that sf3d::IntRect(0, 0, 1, 1) and sf3d::IntRect(1, 1, 1, 1)
/// don't intersect.
///
/// sf3d::Rect is a template and may be used with any numeric type, but
/// for simplicity the instanciations used by SFML3D are typedefed:
/// \li sf3d::Rect<int> is sf3d::IntRect
/// \li sf3d::Rect<float> is sf3d::FloatRect
///
...
/// sf3d::IntRect r1(0, 0, 20, 5);
///
/// // Define another rectangle, located at (4, 2) with a size of 18x10
/// sf3d::Vector2i position(4, 2);
/// sf3d::Vector2i size(18, 10);
/// sf3d::IntRect r2(position, size);
///
