#ifndef SFML3D_CAMERA_HPP
#define SFML3D_CAMERA_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API Camera : public View
{
public :
    ...
    /// \code
    /// sf3d::Vector3f scale = camera.getScale();
...
/// \ingroup graphics
///
/// sf3d::Camera defines a camera in the 3D scene. This is a
/// very powerful concept: you can move, rotate or zoom
/// the entire scene without altering the way that your
/// drawable objects are drawn.
///
/// An sf3d::Camera is much like a camera in real life. It has
...
///
/// Because sf3d::Camera inherits from sf3d::View, its viewport
...
///
/// sf3d::Camera can be combined with sf3d::View to render a scene
/// using a 3D perspective and then to render 2D elements such as
/// text or a GUI using an sf3d::View. Just switch back and forth
...
/// camera.setViewport(sf3d::FloatRect(0.f, 0.f, 1.f, 0.5f));
///
/// // Apply it
...
///
/// \see sf3d::View, sf3d::RenderWindow, sf3d::RenderTexture
///
////////////////////////////////////////////////////////////
