...
#ifndef SFML3D_TEXTURE_HPP
#define SFML3D_TEXTURE_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API Texture : GlResource
{
public :
...
public :
    ...
    /// which will instruct SFML3D to create 1D and 2D textures
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool loadFromStream(sf3d::InputStream& stream, const IntRect& area = IntRect());
    ...
    /// mix sf3d::Texture with OpenGL code.
    ///
    /// \code
    /// sf3d::Texture t1, t2;
    /// ...
    /// sf3d::Texture::bind(&t1);
    /// // draw OpenGL stuff that use t1...
    /// sf3d::Texture::bind(&t2);
    /// // draw OpenGL stuff that use t2...
    /// sf3d::Texture::bind(NULL);
    ...
    /// the graphics classes of SFML3D, it makes the definition of texture
...
#endif // SFML3D_TEXTURE_HPP

////////////////////////////////////////////////////////////
/// \class sf3d::Texture
/// \ingroup graphics
///
/// sf3d::Texture stores pixels that can be drawn, with a sprite
...
/// A texture cannot be manipulated as freely as a sf3d::Image,
/// you need to prepare the pixels first and then upload them
/// to the texture in a single operation (see Texture::update).
///
/// sf3d::Texture makes it easy to convert from/to sf3d::Image, but
...
/// sf3d::Image, do whatever you need with the pixels, and then call
...
/// of booleans.
///
/// Like sf3d::Image, sf3d::Texture can handle a unique internal
/// representation of pixels, which is RGBA 32 bits. This means
/// that a pixel must be composed of 8 bits red, green, blue and
/// alpha channels -- just like a sf3d::Color.
///
/// Usage example:
/// \code
/// // This example shows the most common use of sf3d::Texture:
/// // drawing a sprite
///
...
///
/// \code
/// // This example shows another common use of sf3d::Texture:
...
///
///     // update the texture
///     sf3d::Uint8* pixels = ...; // get a fresh chunk of pixels (the next frame of a movie, for example)
...
/// \endcode
///
/// Like sf3d::Shader that can be used as a raw OpenGL shader,
/// sf3d::Texture can also be used directly as a raw texture for
/// custom OpenGL geometry.
/// \code
/// sf3d::Texture::bind(&texture);
/// ... render OpenGL geometry ...
/// sf3d::Texture::bind(NULL);
/// \endcode
///
/// \see sf3d::Sprite, sf3d::Image, sf3d::RenderTexture
///
////////////////////////////////////////////////////////////
