...
#ifndef SFML3D_VIEW_HPP
#define SFML3D_VIEW_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API View
{
public :
    ...
    /// be defined with View.setViewport(sf3d::FloatRect(0, 0, 0.5, 1)).
...
/// \ingroup graphics
///
/// sf3d::View defines a camera in the 2D scene. This is a
...
/// view.reset(sf3d::FloatRect(100, 100, 400, 200));
///
/// // Rotate it by 45 degrees
/// view.rotate(45);
///
/// // Set its target viewport to be half of the window
/// view.setViewport(sf3d::FloatRect(0.f, 0.f, 0.5f, 1.f));
///
/// // Apply it
/// window.setView(view);
///
...
///
/// \see sf3d::RenderWindow, sf3d::RenderTexture
///
////////////////////////////////////////////////////////////
