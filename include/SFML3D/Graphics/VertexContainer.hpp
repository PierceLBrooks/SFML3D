#ifndef SFML3D_VERTEXCONTAINER_HPP
#define SFML3D_VERTEXCONTAINER_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API VertexContainer : public Drawable
{
public :
...
#endif // SFML3D_VERTEXCONTAINER_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::VertexContainer
/// \ingroup graphics
///
/// sf3d::VertexContainer is a very simple wrapper around a dynamic
/// container of vertices and a primitives type.
///
/// It inherits sf3d::Drawable, but unlike other drawables it
/// is not transformable.
///
/// sf3d::VertexContainer is a simple proxy class that automatically
/// selects the best method of vertex storage. It will make use
/// of an sf3d::VertexBuffer if it is available and fall back
/// to sf3d::VertexArray if not.
///
...
/// Example:
/// \code
/// sf3d::VertexContainer lines(sf3d::LinesStrip, 4);
...
/// \endcode
///
/// \see sf3d::Vertex, sf3d::VertexArray, sf3d::VertexBuffer
///
////////////////////////////////////////////////////////////
