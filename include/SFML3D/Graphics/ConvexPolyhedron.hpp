...
#ifndef SFML3D_CONVEXPOLYHEDRON_HPP
#define SFML3D_CONVEXPOLYHEDRON_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API ConvexPolyhedron : public Polyhedron
{
public :
...
#endif // SFML3D_CONVEXPOLYHEDRON_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::ConvexPolyhedron
/// \ingroup graphics
///
...
/// Usage example:
/// \code
/// sf3d::ConvexPolyhedron polyhedron;
/// polyhedron.setFaceCount(4);
/// polyhedron.setFace(0, sf3d::Vector3f(0, -10, -10), sf3d::Vector3f(10, -10, 10), sf3d::Vector3f(-10, -10, 10));
/// polyhedron.setFace(1, sf3d::Vector3f(10, -10, 10), sf3d::Vector3f(0, -10, -10), sf3d::Vector3f(0, 10, 0));
/// polyhedron.setFace(2, sf3d::Vector3f(-10, -10, 10), sf3d::Vector3f(10, -10, 10), sf3d::Vector3f(0, 10, 0));
/// polyhedron.setFace(3, sf3d::Vector3f(0, -10, -10), sf3d::Vector3f(-10, -10, 10), sf3d::Vector3f(0, 10, 0));
/// polyhedron.generateNormals();
/// polyhedron.setColor(sf3d::Color::Red);
/// polyhedron.setPosition(10, 20, 30);
/// ...
/// window.draw(polyhedron);
/// \endcode
///
/// \see sf3d::Polyhedron, sf3d::Cuboid, sf3d::SphericalPolyhedron
///
////////////////////////////////////////////////////////////
