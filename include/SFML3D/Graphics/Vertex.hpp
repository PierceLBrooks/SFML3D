...
#ifndef SFML3D_VERTEX_HPP
#define SFML3D_VERTEX_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API Vertex
{
public :
...
/// extra attributes that will be used for drawing: in SFML3D,
...
/// sprites, texts, etc.
///
/// If you use the graphical entities of SFML3D (sprite, text, shape)
...
/// sf3d::Vertex vertices[] =
/// {
///     sf3d::Vertex(sf3d::Vector3f(  0,   0, 0), sf3d::Color::Red, sf3d::Vector2f( 0,  0)),
///     sf3d::Vertex(sf3d::Vector3f(  0, 100, 0), sf3d::Color::Red, sf3d::Vector2f( 0, 10)),
///     sf3d::Vertex(sf3d::Vector3f(100, 100, 0), sf3d::Color::Red, sf3d::Vector2f(10, 10)),
///     sf3d::Vertex(sf3d::Vector3f(  0,   0, 0), sf3d::Color::Red, sf3d::Vector2f( 0,  0)),
///     sf3d::Vertex(sf3d::Vector3f(100, 100, 0), sf3d::Color::Red, sf3d::Vector2f(10, 10)),
///     sf3d::Vertex(sf3d::Vector3f(100,   0, 0), sf3d::Color::Red, sf3d::Vector2f(10,  0))
/// };
///
/// // draw it
/// window.draw(vertices, 6, sf3d::Triangles);
/// \endcode
///
...
///
/// \see sf3d::VertexArray, sf3d::VertexBuffer, sf3d::VertexContainer
///
////////////////////////////////////////////////////////////
