...
#ifndef SFML3D_TRANSFORMABLE_HPP
#define SFML3D_TRANSFORMABLE_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API Transformable
{
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setRotation(float angle, const sf3d::Vector3f& axis);
    ...
    /// \code
    /// sf3d::Vector3f pos = object.getPosition();
    ...
    /// Thus, it is equivalent to the following code:
    /// \code
    /// sf3d::Vector3f scale = object.getScale();
...
#endif // SFML3D_TRANSFORMABLE_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::Transformable
/// \ingroup graphics
///
/// This class is provided for convenience, on top of sf3d::Transform.
///
/// sf3d::Transform, as a low-level class, offers a great level of
...
///
/// That's exactly what sf3d::Transformable was written for: it hides
...
/// transform (as a sf3d::Transform), and keeps it up-to-date.
///
/// In addition to the position, rotation and scale, sf3d::Transformable
...
/// bottom-right corner.
///
/// To keep the sf3d::Transformable class simple, there's only one
/// origin for all the components. You cannot position the sprite
/// relatively to its top-left corner while rotating it around its
/// center, for example. To do such things, use sf3d::Transform directly.
///
/// sf3d::Transformable can be used as a base class. It is often
/// combined with sf3d::Drawable -- that's what SFML3D's sprites,
/// texts and shapes do.
/// \code
/// class MyEntity : public sf3d::Transformable, public sf3d::Drawable
/// {
...
///     }
///
///     void Draw(sf3d::RenderTarget& target) const
///     {
///         target.draw(..., myTransform.getTransform());
///     }
///
/// private :
///     sf3d::Transformable myTransform;
/// };
/// \endcode
///
/// A note on coordinates and undistorted rendering: \n
/// By default, SFML3D (or more exactly, OpenGL) may interpolate drawable objects
/// such as sprites or texts when rendering. While this allows transitions
/// like slow movements or rotations to appear smoothly, it can lead to
/// unwanted results in some cases, for example blurred or distorted objects.
/// In order to render a sf3d::Drawable object pixel-perfectly, make sure
