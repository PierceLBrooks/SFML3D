...
#ifndef SFML3D_LIGHT_HPP
#define SFML3D_LIGHT_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API Light : GlResource
{
public :
    ...
    /// light source is sf3d::Color::White.
    ///
    ...
    /// \code
    /// sf3d::Vector3f pos = light.getPosition();
...
#endif // SFML3D_LIGHT_HPP

////////////////////////////////////////////////////////////
/// \class sf3d::Light
/// \ingroup graphics
///
/// sf3d::Light defines a light source in the 3D scene.
...
///
/// sf3d::Light supports 2 different types of lights, positional
...
/// exactly this reason.
///
/// As with lights in real life, an sf3d::Light emits light of a
...
/// can be modelled in sf3d::Light as well using the provided
/// attenuation factors.
...
/// as intended. The various sf3d::Polyhedron classes have methods
...
///
/// A technical detail to keep in mind is that sf3d::Light makes
/// use of the fixed-function OpenGL lighting functionality.
/// This means that:
/// \li The number of light sources you can create with sf3d::Light is limited
...
/// light.setAmbientColor(sf3d::Color(50, 50, 50));
