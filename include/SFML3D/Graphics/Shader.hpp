...
#ifndef SFML3D_SHADER_HPP
#define SFML3D_SHADER_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API Shader : GlResource, NonCopyable
{
public :
...
public :
    ...
    /// \endcode
    /// \code
    /// shader.setParameter("myparam", sf3d::Vector2i(5, 6));
    /// \endcode
    ///
    /// \param name   Name of the parameter in the shader
    ...
    /// \endcode
    /// \code
    /// shader.setParameter("myparam", sf3d::Vector3f(5, 6, -8));
    /// \endcode
    ///
    /// \param name   Name of the parameter in the shader
    /// \param vector Vector to assign
    ...
    /// \endcode
    /// \code
    /// shader.setParameter("myparam", sf3d::Vector2f(5.2f, 6.0f));
    /// \endcode
    ///
    /// \param name   Name of the parameter in the shader
    /// \param vector Vector to assign
    ...
    /// \endcode
    /// \code
    /// shader.setParameter("myparam", sf3d::Vector3f(5.2f, 6.0f, -8.1f));
    /// \endcode
    ///
    /// \param name   Name of the parameter in the shader
    /// \param vector Vector to assign
    ...
    /// For example, a sf3d::Color(255, 125, 0, 255) will be transformed
    ...
    /// \endcode
    /// \code
    /// shader.setParameter("color", sf3d::Color(255, 128, 0, 255));
    /// \endcode
    ///
    /// \param name  Name of the parameter in the shader
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setParameter(const std::string& name, const sf3d::Transform& transform) const;
    ...
    /// sf3d::Shader::CurrentTexture:
    /// \code
    /// shader.setParameter("the_texture", sf3d::Shader::CurrentTexture).
    /// \endcode
    ///
    ...
    /// \endcode
    /// \code
    /// shader.setParameter("current", sf3d::Shader::CurrentTexture);
    /// \endcode
    ///
    /// \param name Name of the texture in the shader
    ///
    ...
    /// shader.setParameter("color1", sf3d::Color(255, 128, 0,   255));
    /// shader.setParameter("color2", sf3d::Color(255, 255, 128, 255));
    /// shader.setParameter("color3", sf3d::Color(0,   128, 255, 255));
    /// shader.setParameter("color4", sf3d::Color(0,   255, 0,   255));
    ...
    /// mix sf3d::Shader with OpenGL code.
    ///
    /// \code
    /// sf3d::Shader s1, s2;
    /// ...
    ...
    /// any attempt to use sf3d::Shader will fail.
    ///
...
///
/// A sf3d::Shader can be composed of either a vertex shader
...
/// that you can set from your C++ application. sf3d::Shader
...
/// shader.setParameter("color", sf3d::Color(128, 50, 255));
/// shader.setParameter("matrix", transform); // transform is a sf3d::Transform
/// shader.setParameter("overlay", texture); // texture is a sf3d::Texture
/// shader.setParameter("texture", sf3d::Shader::CurrentTexture);
/// \endcode
///
...
/// \li w is unused
///
/// Here is a list of the built-in SFML3D shader vertex attributes:
...
/// not interesting. For example, using a vertex shader on a sf3d::Sprite
/// is limited because there are only 4 vertices, the sprite would
/// have to be subdivided in order to apply wave effects.
/// Another bad example is a fragment shader with sf3d::Text: the texture
...
/// current contents of the target (like the old sf3d::PostFx class
/// in SFML3D 1). This can be done in two different ways:
/// \li draw everything to a sf3d::RenderTexture, then draw it to
///     the main target using the shader
/// \li draw everything directly to the main target, then use
///     sf3d::Texture::update(Window&) to copy its contents to a texture
...
///
/// Like sf3d::Texture that can be used as a raw OpenGL texture,
/// sf3d::Shader can also be used directly as a raw shader for
/// custom OpenGL geometry.
/// \code
/// sf3d::Shader::bind(&shader);
