...
#ifndef SFML3D_FONT_HPP
#define SFML3D_FONT_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API Font
{
public :
...
public :
    ...
    /// The supported font formats are: TrueType, Type 1, CFF,
    /// OpenType, SFNT, X11 PCF, Windows FNT, BDF, PFR and Type 42.
    /// Warning: SFML3D cannot preload all the font data in this
...
private :
    ...
    struct Page
    {
        ...
        sf3d::Texture      texture; ///< Texture containing the pixels of the glyphs
...
///
/// Once it is loaded, a sf3d::Font instance provides three
...
/// use the sf3d::Text class, which is able to properly output text
/// with several options such as character size, style, color,
/// position, rotation, etc.
/// This separation allows more flexibility and better performances:
/// indeed a sf3d::Font is a heavy resource, and any operation on it
/// is slow (often too slow for real-time applications). On the other
/// side, a sf3d::Text is a lightweight object which can combine the
/// glyphs data and metrics of a sf3d::Font to display any text on a
/// render target.
/// Note that it is also possible to bind several sf3d::Text instances
/// to the same sf3d::Font.
///
...
/// text1.setStyle(sf3d::Text::Regular);
///
/// // Create another text using the same font, but with different parameters
/// sf3d::Text text2;
/// text2.setFont(font);
/// text2.setCharacterSize(50);
/// text1.setStyle(sf3d::Text::Italic);
/// \endcode
///
/// Apart from loading font files, and passing them to instances
/// of sf3d::Text, you should normally not have to deal directly
