...
#ifndef SFML3D_RENDERTEXTURE_HPP
#define SFML3D_RENDERTEXTURE_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_GRAPHICS_API RenderTexture : public RenderTarget
{
public :
    ...
    /// The internal sf3d::Texture of a render-texture is always the
...
#endif // SFML3D_RENDERTEXTURE_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::RenderTexture
/// \ingroup graphics
///
/// sf3d::RenderTexture is the little brother of sf3d::RenderWindow.
/// It implements the same 2D drawing and OpenGL-related functions
/// (see their base class sf3d::RenderTarget for more details),
...
///    texture.clear(sf3d::Color::Red);
///
///    // Draw stuff to the texture
///    texture.draw(sprite);  // sprite is a sf3d::Sprite
///    texture.draw(shape);   // shape is a sf3d::Shape
///    texture.draw(text);    // text is a sf3d::Text
///
...
///
///    // Draw the texture
///    sf3d::Sprite sprite(texture.getTexture());
///    window.draw(sprite);
///
...
/// \endcode
///
/// Like sf3d::RenderWindow, sf3d::RenderTexture is still able to render direct
/// OpenGL stuff. It is even possible to mix together OpenGL calls
/// and regular SFML3D drawing commands. If you need a depth buffer for
/// 3D rendering, don't forget to request it when calling RenderTexture::create.
///
/// \see sf3d::RenderTarget, sf3d::RenderWindow, sf3d::View, sf3d::Texture
///
////////////////////////////////////////////////////////////
