...
#ifndef SFML3D_BOX_HPP
#define SFML3D_BOX_HPP
...
#include <SFML3D/Graphics/Box.inl>
...
///
/// To keep things simple, sf3d::Box doesn't define
/// functions to emulate the properties that are not directly
/// members (such as right, bottom, center, etc.), it rather
/// only provides intersection functions.
///
/// sf3d::Box uses the usual rules for its boundaries:
...
///
/// This means that sf3d::IntBox(0, 0, 0, 1, 1, 1) and
/// sf3d::IntBox(1, 1, 1, 1, 1, 1) don't intersect.
///
/// sf3d::Box is a template and may be used with any numeric type, but
/// for simplicity the instanciations used by SFML3D are typedefed:
/// \li sf3d::Box<int> is sf3d::IntBox
/// \li sf3d::Box<float> is sf3d::FloatBox
///
...
/// sf3d::IntBox box1(0, 0, 0, 20, 5, 10);
///
/// // Define another box, located at (4, 2, 3) with a size of 18x10x14
/// sf3d::Vector3i position(4, 2, 3);
/// sf3d::Vector3i size(18, 10, 14);
/// sf3d::IntBox box2(position, size);
///
