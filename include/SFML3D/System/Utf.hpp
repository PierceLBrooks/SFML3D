...
#ifndef SFML3D_UTF_HPP
#define SFML3D_UTF_HPP
...
public :
    ...
    /// specializations of the sf3d::Utf<> template, and allow
...
public :
    ...
    /// of sf3d::Utf<>, it is defined for convenience (it is used by
...
///
/// sf3d::Utf is a low-level, generic interface for counting, iterating,
...
///
/// sf3d::Utf<X> functions are all static, these classes are not meant to
/// be instantiated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li sf3d::Utf<8> (typedef'd to sf3d::Utf8)
/// \li sf3d::Utf<16> (typedef'd to sf3d::Utf16)
/// \li sf3d::Utf<32> (typedef'd to sf3d::Utf32)
///
////////////////////////////////////////////////////////////
