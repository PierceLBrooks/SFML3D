...
#ifndef SFML3D_NONCOPYABLE_HPP
#define SFML3D_NONCOPYABLE_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_SYSTEM_API NonCopyable
{
protected :
...
#endif // SFML3D_NONCOPYABLE_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::NonCopyable
/// \ingroup system
///
...
/// in sf3d::NonCopyable so they will end up being inaccessible in both
/// cases. Thus you can use a shorter syntax for inheriting from it
/// (see below).
///
/// Usage example:
/// \code
/// class MyNonCopyableClass : sf3d::NonCopyable
/// {
///     ...
/// };
/// \endcode
...
/// and to use sf3d::NonCopyable when necessary to prevent
