...
#ifndef SFML3D_THREAD_HPP
#define SFML3D_THREAD_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_SYSTEM_API Thread : NonCopyable
{
public :
    ...
    /// cannot survive after its sf3d::Thread instance is destroyed.
    ///
    ////////////////////////////////////////////////////////////
    ~Thread();
...
#include <SFML3D/System/Thread.inl>

} // namespace sf3d

#endif // SFML3D_THREAD_HPP
...
/// in parallel.
///
/// To use a sf3d::Thread, you construct it directly with the
/// function to execute as the entry point of the thread.
/// sf3d::Thread has multiple template constructors, which means
...
///
/// The function argument, if any, is copied in the sf3d::Thread
...
/// owner sf3d::Thread instance is destroyed before the
...
/// }
///
/// sf3d::Thread thread(&threadFunc, 5);
...
///
/// Task task;
/// sf3d::Thread thread(&Task::run, &task);
...
/// kind of situations, you can use mutexes (see sf3d::Mutex).
///
/// \see sf3d::Mutex
///
////////////////////////////////////////////////////////////
