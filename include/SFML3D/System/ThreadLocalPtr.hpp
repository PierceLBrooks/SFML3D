...
#ifndef SFML3D_THREADLOCALPTR_HPP
#define SFML3D_THREADLOCALPTR_HPP
...
#include <SFML3D/System/ThreadLocalPtr.inl>


#endif // SFML3D_THREADLOCALPTR_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::ThreadLocalPtr
/// \ingroup system
///
/// sf3d::ThreadLocalPtr is a type-safe wrapper for storing
...
/// MyClass object1;
/// MyClass object2;
/// sf3d::ThreadLocalPtr<MyClass> objectPtr;
///
/// void thread1()
/// {
...
///     sf3d::Thread t1(&thread1);
///     sf3d::Thread t2(&thread2);
///     t1.launch();
///     t2.launch();
///
///     return 0;
