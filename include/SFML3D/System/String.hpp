...
#ifndef SFML3D_STRING_HPP
#define SFML3D_STRING_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_SYSTEM_API String
{
public :
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new sf3d::String from a UTF-8 encoded string
    ///
    /// \param begin Forward iterator to the begining of the UTF-8 sequence
    /// \param end   Forward iterator to the end of the UTF-8 sequence
    ///
    /// \return A sf3d::String containing the source string
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new sf3d::String from a UTF-16 encoded string
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new sf3d::String from a UTF-32 encoded string
    ///
    /// This function is provided for consistency, it is equivalent to
    /// using the constructors that takes a const sf3d::Uint32* or
    /// a std::basic_string<sf3d::Uint32>.
    ///
...
private :
    ...
    friend SFML3D_SYSTEM_API bool operator ==(const String& left, const String& right);
    friend SFML3D_SYSTEM_API bool operator <(const String& left, const String& right);
...
///
////////////////////////////////////////////////////////////
SFML3D_SYSTEM_API bool operator ==(const String& left, const String& right);
...
///
////////////////////////////////////////////////////////////
SFML3D_SYSTEM_API String operator +(const String& left, const String& right);

#include <SFML3D/System/String.inl>

} // namespace sf3d


#endif // SFML3D_STRING_HPP
...
/// \ingroup system
///
/// sf3d::String is a utility string class defined mainly for
...
/// s = sf3d::String("hello", locale);
/// \endcode
///
/// sf3d::String defines the most important functions of the
/// standard std::string class: removing, random access, iterating,
/// appending, comparing, etc. However it is a simple class
/// provided for convenience, and you may have to consider using
/// a more optimized class if your program requires complex string
/// handling. The automatic conversion functions will then take
/// care of converting your string to sf3d::String whenever SFML3D
/// requires it.
///
/// Please note that SFML3D also defines a low-level, generic
/// interface for Unicode handling, see the sf3d::Utf classes.
///
////////////////////////////////////////////////////////////
