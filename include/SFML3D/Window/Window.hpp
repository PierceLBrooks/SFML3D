...
public :
    ...
    /// SFML3D chose the closest match.
    ///
    ...
    /// SFML3D will try to match the given limit as much as it can,
    ...
    /// very specific stuff to implement that SFML3D doesn't support,
...
/// sf3d::Window window(sf3d::VideoMode(800, 600), "SFML3D window");
///
