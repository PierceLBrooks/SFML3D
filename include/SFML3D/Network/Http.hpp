...
#ifndef SFML3D_HTTP_HPP
#define SFML3D_HTTP_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_NETWORK_API Http : NonCopyable
{
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    class SFML3D_NETWORK_API Request
    {
    public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    class SFML3D_NETWORK_API Response
    {
    public :
...
/// \ingroup network
///
/// sf3d::Http is a very simple HTTP client that allows you
/// to communicate with a web server. You can retrieve
/// web pages, send data to an interactive resource,
/// download a remote file, etc.
///
/// The HTTP client is split into 3 classes:
/// \li sf3d::Http::Request
/// \li sf3d::Http::Response
/// \li sf3d::Http
///
/// sf3d::Http::Request builds the request that will be
...
///
/// sf3d::Http::Response parse the response from the web server
/// and provides getters to read them. The response contains:
/// \li a status code
/// \li header fields (that may be answers to the ones that you requested)
/// \li a body, which contains the contents of the requested resource
///
/// sf3d::Http provides a simple function, SendRequest, to send a
/// sf3d::Http::Request and return the corresponding sf3d::Http::Response
/// from the server.
///
/// Usage example:
/// \code
...
/// sf3d::Http http;
///
/// // We'll work on http://www.sfml3d-dev.org
/// http.setHost("http://www.sfml3d-dev.org");
///
/// // Prepare a request to get the 'features.php' page
/// sf3d::Http::Request request("features.php");
///
/// // Send the request
/// sf3d::Http::Response response = http.sendRequest(request);
///
/// // Check the status code and display the result
/// sf3d::Http::Response::Status status = response.getStatus();
/// if (status == sf3d::Http::Response::Ok)
/// {
