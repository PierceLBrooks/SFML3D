...
#ifndef SFML3D_FTP_HPP
#define SFML3D_FTP_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_NETWORK_API Ftp : NonCopyable
{
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    class SFML3D_NETWORK_API DirectoryResponse : public Response
    {
    public :
    ...
    ///        filename lisiting
    ////////////////////////////////////////////////////////////
    class SFML3D_NETWORK_API ListingResponse : public Response
    {
    public :
    ...
    /// functions in the sf3d::Ftp class, this method can be used
...
/// \ingroup network
///
/// sf3d::Ftp is a very simple FTP client that allows you
...
/// sf3d::Ftp::Response to provide this data. The most often used
...
/// sf3d::Ftp::Response response = ftp.connect("ftp://ftp.myserver.com");
/// if (response.isOk())
...
/// sf3d::Ftp::DirectoryResponse directory = ftp.getWorkingDirectory();
/// if (directory.isOk())
...
/// response = ftp.upload("local-path/file.txt", "files", sf3d::Ftp::Ascii);
/// if (response.isOk())
