...
namespace
{
    ...
    void updatePluggedList()
    {
        ...
        if ((dp = opendir("/dev")) != NULL) {
            ...
            while ((entry = readdir(dp)) != NULL && jc < sf3d::Joystick::Count) {
    ...
    int usageToAxis(int usage)
    {
        ...
        switch (usage) {
        case HUG_X:
            axis = sf3d::Joystick::X;
            break;
        case HUG_Y:
            axis = sf3d::Joystick::Y;
            break;
        case HUG_Z:
            axis = sf3d::Joystick::Z;
            break;
        case HUG_RZ:
            axis = sf3d::Joystick::R;
            break;
        case HUG_RX:
            axis = sf3d::Joystick::U;
            break;
        case HUG_RY:
            axis = sf3d::Joystick::V;
            break;
        default:
            axis = -1;
            break;
    ...
    void hatvalToSFML3D(int value, sf3d::priv::JoystickState &state)
    {
        state.axes[sf3d::Joystick::PovX] = hatmap[value].first;
        state.axes[sf3d::Joystick::PovY] = hatmap[value].second;
    }
}
