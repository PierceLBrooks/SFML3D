...
#include <SFML3D/Window/glext/glext.h>
#include <set>
#include <cstdlib>
#include <cassert>
...
namespace
{
    ...
    // Internal contexts
    sf3d::ThreadLocalPtr<sf3d::priv::GlContext> internalContext(NULL);
    std::set<sf3d::priv::GlContext*> internalContexts;
    sf3d::Mutex internalContextsMutex;
