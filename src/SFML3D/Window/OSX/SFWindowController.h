...
@interface SFWindowController : NSResponder <WindowImplDelegateProtocol, NSWindowDelegate> {
    ...
    sf3d::priv::WindowImplCocoa*  m_requester;
    sf3d::VideoMode*              m_fullscreenMode; // Note : C++ ctor/dtor are not called for Obj-C fields.
}

////////////////////////////////////////////////////////////
/// Create the SFML3D window with an external Cocoa window.
///
////////////////////////////////////////////////////////////
-(id)initWithWindow:(NSWindow *)window;

////////////////////////////////////////////////////////////
/// Create the SFML3D window "from scratch" (full SFML3D handling).
///
////////////////////////////////////////////////////////////
