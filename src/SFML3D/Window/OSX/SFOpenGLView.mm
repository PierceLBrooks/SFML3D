...
////////////////////////////////////////////////////////////
/// Convert the NSEvent mouse button type to SFML3D type.
///
...
////////////////////////////////////////////////////////////
/// Convert a key down/up NSEvent into an SFML3D key event.
/// Based on localizedKeys and nonLocalizedKeys function.
///
/// Return sf3d::Keyboard::Unknown as Code if the key is unknown.
///
////////////////////////////////////////////////////////////
+(sf3d::Event::KeyEvent)convertNSKeyEventToSFML3DEvent:(NSEvent *)anEvent;
...
{
    sf3d::Mouse::Button button = [self mouseButtonFromEvent:theEvent];
    ...
    if (button != sf3d::Mouse::Left && button != sf3d::Mouse::Right) {
        // ... transmit to non-SFML3D responder
...
+(sf3d::Event::KeyEvent)convertNSKeyEventToSFML3DEvent:(NSEvent *)anEvent
{
    ...
    if (key == sf3d::Keyboard::Unknown) {
        key = sf3d::priv::HIDInputManager::nonLocalizedKeys([anEvent keyCode]);
    }

//#ifdef SFML3D_DEBUG // Don't bother the final customers with annoying messages.
//    if (key.code == sf3d::Keyboard::Unknown) { // The key is unknown.
