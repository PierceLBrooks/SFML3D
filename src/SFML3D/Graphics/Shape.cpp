...
namespace
{
    ...
    sf3d::Vector2f computeNormal(const sf3d::Vector2f& p1, const sf3d::Vector2f& p2)
    {
        sf3d::Vector2f normal(p1.y - p2.y, p2.x - p1.x);
    ...
    float dotProduct(const sf3d::Vector2f& p1, const sf3d::Vector2f& p2)
    {
...
void Shape::setTexture(const Texture* texture, bool resetRect)
{
    if (texture)
    {
        ...
        if (resetRect || (!m_texture && (m_textureRect == sf3d::IntRect())))
