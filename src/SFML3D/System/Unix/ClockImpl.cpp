...
// Headers
////////////////////////////////////////////////////////////
#include <SFML3D/System/Unix/ClockImpl.hpp>
...
Time ClockImpl::getCurrentTime()
{
    ...
    return sf3d::microseconds(nanoseconds / 1000);
    ...
    return sf3d::microseconds(static_cast<Uint64>(time.tv_sec) * 1000000 + time.tv_nsec / 1000);
